...
2 Świat bez sensu: diagnoza poznania, które nie może znieść swojej pustki
...
3 Postulaty meta-nihilistyczne: co pozostaje, gdy zrezygnujesz ze wszystkiego, co miało cię trzymać przy rzeczywistości
...
4 Konsekwencje epistemiczne i ontologiczne: co się dzieje, gdy poznanie zrozumie, że nie jest drogą do świata, lecz jego wytwórcą
...
4.2 Znaczenie jako lokalna konfiguracja adaptacyjna — nie istnieją sensy uniwersalne, tylko tymczasowe układy użyteczności
...
5 Problem metryki poznawczej — czy da się ocenić formę? Jeśli tak, to według jakich metryk?
